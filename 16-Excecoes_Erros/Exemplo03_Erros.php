...
- No php7 todos os erros - fatal error - são convertidos para exception.
*/
...
//set_error_handler recebe como parâmetro o nome da função que deve ser chamada quando ocorrer o erro, por isso indicamos entre aspas, é o nome (string) não é a chamada da função.
