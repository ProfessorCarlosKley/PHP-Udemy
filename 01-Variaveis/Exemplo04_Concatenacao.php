...
//concatenação no php faz-se com o ponto, isso se deve porque a convenção de tipos é feita automaticamente, portanto se for concatentar com sinal de + ele tentará efetuar a soma.
