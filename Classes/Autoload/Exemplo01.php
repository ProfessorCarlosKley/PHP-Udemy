...
function __autoload($nomeClass){
    ...
    /*var_dump($nomeClass); com esse var_dump percebemos o que tem em $nomeClass ao 
    definirmos $carro = new DelRey(); logo abaixo. 
    Ou seja, a função __autoload automaticamente procura NA MESMA PASTA arquivo de mesmo nome da classe DelRey() já que ela não foi defnida nesse módulo.
    Logo, vamos utilizar a função de inclusãro colocando como parâmetro o valor de $nomeClass.

    - A classe DelRey extende de Automovel, a função __autoload já detecta isso e procura deois que acha o arquivo DelRey.php, o arquivo Automovel.php. uma vez que a classe DelRey menciona a classe Automovel.
