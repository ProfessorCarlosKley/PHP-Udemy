...
foreach($animals as $animal) {
    ...
    o comportamento do método definido na classe Animal. Por isso, a mensagem exibida
    aqui é o echo definido em cada classe filha. No caso do, "CACHORRO: late!<br>";
 ...
 * isso acontece porque não temos na classe gato e cachorro um método mover definido.
 ...
 * Em síntese: Métodos com o mesmo nome em classes diferentes, classes herdadas, têm comportamentos diferentes. Na maioria das vezes, têm parâmetros diferentes.
 * Abstract é uma classe mais genérica, por exemplo, não sabemos ainda de que animal tratamos.
 *****************************************************************************************/
?>
